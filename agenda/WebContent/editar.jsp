...
<body>
	...
	<form name="frmContato" action="update">
		<table>
			...
			<tr>
				<td><input type="text" name="data" class="Caixa1" value="<%out.print(request.getAttribute("data"));%>"></td>
			</tr>
			<tr>
				<td><input type="text" name="hora" class="Caixa1" value="<%out.print(request.getAttribute("hora"));%>"></td>
			</tr>
		</table>
