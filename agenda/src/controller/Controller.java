...
public class Controller extends HttpServlet {
	...
	protected void adicionarContato(HttpServletRequest request, HttpServletResponse response)
		...
		contato.setHora(request.getParameter("hora"));
	...
	protected void listarContato(HttpServletRequest request, HttpServletResponse response)
		...
		// Setar os conteudos do formulário com o conteúdo JavaBenas
		request.setAttribute("idcon", contato.getIdcon());
		request.setAttribute("nome", contato.getNome());
		request.setAttribute("fone", contato.getFone());
		request.setAttribute("email", contato.getEmail());
		request.setAttribute("data", contato.getData());
		request.setAttribute("hora", contato.getHora());
	...
	protected void editarContato(HttpServletRequest request, HttpServletResponse response)
		...
		// redirecionar para o documento agenda.jsp (atualizaqndo as alterações)
		response.sendRedirect("main");
	}
	...
	protected void gerarRelatorio(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PdfPCell col5 = new PdfPCell(new Paragraph("Hora"));
			tabela.addCell(col1);
			tabela.addCell(col2);
			tabela.addCell(col3);
			tabela.addCell(col4);
			...
			for (int i = 0; i < lista.size(); i++) {
				...
				tabela.addCell(lista.get(i).getHora());
			}
